...
==**Enablexxx：将组件导入到容器中，eg:EnableAutoConfiguration**==
==**xxxAutoconfiguration：自动配置类，将组件导入到容器, eg: WebMvcAutoConfiguration**==
==**xxxProperties：用于配置导入的组件的属性,eg:WebMvcProperties**==
==**xxxConfiguration：用于扩展功能【导入组件】,eg:WebMvcConfiguration**==
